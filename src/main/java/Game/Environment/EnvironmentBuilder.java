...
public class EnvironmentBuilder {
    ...
    private int startingFirstQuart;
    ...
    public void setStartingFirstQuart(boolean yes){
        this.startingFirstQuart= yes?0:1;
    }
    private void setVariable()
    {
        Random random = new Random();
        if(startingFirstQuart==-1)
            startingFirstQuart = random.ints(0,2).findAny().getAsInt();
        if(this.nbCol == -1)
        {
